...
void Song::setTitle(const string& t){ this->title = t; }
void Song::setArtist(const string& a){ this->artist = a; }
void Song::setDuration(int d){ this->duration = d; }

// FIX: them method nay - duoc goi boi HistoryStack::displayHistory()
